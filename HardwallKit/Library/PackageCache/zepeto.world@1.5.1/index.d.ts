...
declare module 'ZEPETO.World' {
    ...
    class WorldMultiplayChatContent extends System.Object {
        ...
        public add_OnReceivedQuickMessage($value: System.Action$1<UserMessage>):void;
        
        public remove_OnReceivedQuickMessage($value: System.Action$1<UserMessage>):void;
    ...
    enum SystemMessageType { JOIN_USER = 0, LEAVE_USER = 1, JOINED_USERS = 2, QUICK_REPEAT = 3 }
    ...
    enum OfficialContentType { Gesture = 2, Pose = 4, All = 6 }
    ...
    enum MessageType { USER = 0, SYSTEM = 1, NOTICE = 2 }
